...
> **Последнее обновление: 26.08.2026** — по БАД: разобраны выгрузки из ЛК партнёров, починены и заведены карточки, поставлены три плана — навигация через проблематику, исследование каталогов, возвратные механики (вывод: догонять консультацией, а не добавкой). Ранее 25.08: промокод LIST переведён с 17% на 10%.
>
