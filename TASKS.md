...
### T-CONV-009: кнопки на игру в landing.index + выделение на app.main

**Проблема:** после T-CONV-005 игра живёт по `listoshenkov.ru/game`, но **попасть на неё с главной негде**.

**Что нужно:**
1. **Landing index.html** — добавить CTA «🩸 Пройди тест на железо» (по аналогии с тем, как сделана кнопка «🔍 Консультация» в hero)
2. **App.main** — выделить тайл «Полезные игры» (или сделать новый тайл «Тест на железо» прямо на главной) визуально, чтобы бросался в глаза

**Открытый вопрос:** ссылка из app.main вести на listoshenkov.ru/game (внешний SEO-трафик) или на /games/iron/ внутри приложения? Уточнить.
