...
> **Последнее обновление: 30.08.2026** — пуши Ближнего круга доведены до конца, механизм критических значений готов (ждёт цифр). Ранее в тот же день — проверка безопасности: закрыты медданные, читавшиеся публичным ключом, перебор кода входа, SSRF и открытые AI-эндпоинты. Плюс решения по Ближнему кругу.
>
