...
> **Последнее обновление: 27.08.2026** — каталог 114 → 191, песочница чистая по трём ролям, горизонт 2 возврата в проде. Открыто: горизонт 3 (рассылки) ждёт юридической проработки. — по БАД сделаны шаги 1 и 2 из плана навигации: зрение в аналитике (8 событий раздела + честный sessionId/visitor) и блок «С чем пришли?» с 13 протоколами и списком покупок. На dev, ждёт приёмки Алексея.
>
