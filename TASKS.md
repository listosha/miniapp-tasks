...
> **Последнее обновление: 26.08.2026** — по БАД: разобраны выгрузки из ЛК обоих партнёров (раздел «Волшебные таблетки» почти не конвертит), починены и заведены карточки, поставлен план по навигации через проблематику (13 протоколов уже в коде, заперты в квизе) и исследование каталогов. Ранее 25.08: промокод LIST переведён с 17% на 10%.
>
