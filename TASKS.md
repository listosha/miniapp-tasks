...
> **Последнее обновление: 19.08.2026** — в прод выкачен бесплатный гайд «Уколы для похудения: анализы» под email-гейт (проверка гипотезы сопровождения на GLP-1): 13 глав, три формата PDF, изолированная тема оформления, письмо просит ответить. Ранее 13.08: — починен MAX лаб-коллектор: терял файлы из медиа-групп (гонка при параллельных вебхуках). Ранее 11.08: первая живая покупка курса «Диабет» прошла и проверена по всей цепочке; в ленту добавлена подводка из первых строк поста (на dev, ждёт «ок» в прод).
>
