...
## 📧 КНОПКА «ПРИСЛАТЬ ССЫЛКУ НА ПОЧТУ» НА ГЕЙТЕ КУРСА — 🟡 НА DEV 06.09.2026
...
**⏸ Ждёт Алексея:** сказать «ок» на прод. Сейчас на dev; на проде кнопки нет,
хотя сама функция и миграция там уже живут (Supabase один на оба контура).
