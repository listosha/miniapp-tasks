...
> **Последнее обновление: 11.08.2026 (вечер)** — первая живая покупка курса «Диабет» прошла и проверена по всей цепочке. В ленту добавлена подводка из первых строк поста (на dev, ждёт «ок» в прод). Ранее в тот же день: курс «Диабет» выкачен и продаётся, доставка доступа после оплаты переделана.
>
