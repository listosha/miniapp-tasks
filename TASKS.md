...
### ⏳ Конверсия ленты — подводка сделана, на dev (11.08)
...
Проверено на dev headless-браузером: 20 карточек, подводка у всех, ровно две
строки, JS-ошибок нет.

**⏳ Ждёт «ок» на прод** — на dev нет трафика, замер возможен только в бою.
После выкатки: сравнить `post_view` к сессиям за неделю до и неделю после.
