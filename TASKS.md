...
> **Последнее обновление: 12.09.2026 (вечер)** — одобрена идея агента видимости в нейросетях, следующий шаг отложен до 16.09 (напоминалка в MAX стоит). Попутно поднят `lab-collector`: падал с 08.09 из-за отозванного ключа.
>
...
- [x] **Баланс Yandex Cloud раз в день** после 9:00: пишет только когда денег меньше 300 ₽ или
