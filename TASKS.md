...
> **Последнее обновление: 31.05.2026** — СделайМеню: фикс доставки меню (зависшая генерация + сломанный ЛК `digest` + дробление приёмов), группировка приёмов в один блок, правка промпта. Деплой в прод + `miniapp@dev bb9b030`. Ранее (31.05): курс «Гормоны» в прод, партнёрская программа.
>
