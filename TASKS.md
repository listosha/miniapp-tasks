...
> **Последнее обновление: 31.08.2026** — оба предложения Фиксика приняты и выкачены в прод: схема добавок ведёт прямо к покупке, вернувшимся на входе предлагается консультация. Заодно починена петля обучения агента приложения — она не могла закрыться ни разу.
>
