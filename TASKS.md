...
> **Последнее обновление: 27.08.2026** — каталог 191 позиция, кнопка «список на почту», агент «Поползень» на VPS шлёт разбор в MAX. Открыто: горизонт 3 отложен по решению Алексея, вариант Б агента — после накопления статистики.
>
