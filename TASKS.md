...
1. **Серия «Истории восстановления» стоит с 5 августа.** Выпуск #9
   ...
   Чинится одним UPDATE. ⚠️ Как только `attribs` починится, кампания сразу
   продолжит рассылку — это 51 живое письмо, поэтому жду «ок».
