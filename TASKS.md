...
> **Последнее обновление: 25.08.2026** — промокод LIST на Артлайф переведён с 17% на 10% везде (база: 63 карточки «Волшебных таблеток» + 58 записей каталога БАД; три гайда и генератор). Ранее 22.08: ссылка доступа к курсу стала многоразовой, гость на карточке курса видит вход по почте. Ранее 19.08: в прод выкачен бесплатный гайд «Уколы для похудения: анализы» под email-гейт.
>
