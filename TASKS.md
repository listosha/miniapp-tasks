...
> **Последнее обновление: 29.08.2026** — Ближний круг: переписка убрана, разбор в карточке документа, Обзор → дашборд, агент назван «Душнила». План — `miniapp/docs/blizhniy-krug-plan.md`.
>
