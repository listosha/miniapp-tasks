...
> **Последнее обновление: 30.08.2026** — проверка безопасности: закрыты медданные, читавшиеся публичным ключом, перебор кода входа, SSRF и открытые AI-эндпоинты. Плюс решения по Ближнему кругу.
>
