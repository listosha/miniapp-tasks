...
> **Последнее обновление: 27.08.2026 (ночь)** — по БАД сделаны шаги 1 и 2 из плана навигации: зрение в аналитике (8 событий раздела + честный sessionId/visitor) и блок «С чем пришли?» с 13 протоколами и списком покупок. На dev, ждёт приёмки Алексея.
>
