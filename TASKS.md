...
> **Последнее обновление: 09.09.2026 (утро)** — ночная работа по двум задачам Алексея: прогон в песочнице по сценариям посетителя и Фиксик. Восемь находок, семь починены, всё на `dev`. Подробный отчёт — `miniapp/docs/night-audit-2026-09-09.md`.
>
