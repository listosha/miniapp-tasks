...
**Приоритет:** 🔴 | **Статус:** ✅ Выполнено (DEV) — ждёт ОК Алексея перед мержем в PROD
...
**Приоритет:** 🔴 | **Статус:** ✅ Выполнено | **Зависимости:** T-QUIZ-PROMPTS-RLS
...
**Приоритет:** 🔴 | **Статус:** ✅ Выполнено | **Зависимости:** T-QUIZ-PROMPTS-COMMON
