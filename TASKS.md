...
- [ ] **Выложить 9 заметок** (готовы в `C:/Users/listo/landing-source/zametki-vidimost/`), ждут «ок»:
      html → sitemap.xml → `/root/landing-md/regen.sh` → карточки в списке заметок → IndexNow.
