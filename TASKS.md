...
> **Последнее обновление: 02.09.2026** — «Ближний круг»: нормализатор написания единиц сделан. Непроверенных записей 12 вместо 41, пороги критических значений разблокированы. Первое же срабатывание оказалось ложным красным — снято. Отчёт: `miniapp/docs/private-units-normalizer-2026-09-02.md`.
>
...
- **Блок 2:** ✅ **нормализатор написания единиц сделан 02.09.** Непроверенных записей 12
  ...
  при сборке Душнилы. Дальше: матчер (абсолютные значения под процентными маркерами
  у эозинофилов/моноцитов/лимфоцитов/базофилов, моча под кровью), отдельный API-ключ
  из Console, расчёт российской модели.
...
ключей → забор по ссылке → форма «написать» → матчер.
