...
**Статус:** ✅ Задеплоено на dev (commit 65b8a07)
- zhelezodeficit: полная глава 1 — анализы, 5 причин блокировки, расшифровка ферритина/ОЖСС/трансферрина
- Paywall-блок после главы: «✓ Глава 1 из 8 открыта», список глав 2–5, кнопка «Получить полный гайд — X ₽»
- Учитывает game_discount (цена в paywall = цена со скидкой если есть)
- Остальные гайды показывают старый blurred preview без изменений
